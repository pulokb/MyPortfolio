      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header pb-0">
              <h3>Select sizing</h3>
              <p class="f-m-light mt-1"> <code>.form-select</code> to trigger the custom styles. You may also choose from small and large custom selects to match our similarly sized text inputs. class:- <code>[form-select-lg/form-select-sm]</code>.</p>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header pb-0">
              <h3>File input </h3>
              <p class="f-m-light mt-1">
                 For default file/multiple file/disabled file/small file/large file input for use <code>&lt;input&gt; </code>with <code>(type='file').</code></p>
            </div>
            <div class="card-body">
              <div class="mb-3">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-2">
                        <input class="form-control form-control-color" type="color" value="#307EF3">
                      </div>
                    </div>
                    <div class="mb-3 row">
        ...
        <div class="col-xl-6">
          <div class="card height-equal">
            <div class="card-header pb-0">
              <h3>Basic floating input control</h3>
              <p class="f-m-light mt-1">
                 Give textual form controls like <code>&lt;input&gt;</code>s and <code>&lt;textarea&gt;</code>s an upgrade with custom styles, sizing, focus states, and more.</p>
            </div>
            <form class="form theme-form">
            ...
            <form class="form theme-form dark-inputs">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect7">Select your favorite pixelstrap theme</label>
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      ...
                      <input class="form-control btn-pill" type="text" placeholder="Default input" aria-label="default input example">
                    </div>
                  </div>
                </div>
                <div class="row">
            ...
            <form class="form theme-form dark-inputs">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect17">Select your favorite pixelstrap theme</label>
