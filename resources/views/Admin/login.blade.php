      ...
      <div class="row m-0">
        <div class="col-12 p-0">
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="#"><img class="img-fluid for-light" src="dunzo/images/logo/logo-1.png" alt="looginpage"><img class="img-fluid for-dark" src="dunzo/images/logo/logo.png" alt="looginpage"></a></div>
